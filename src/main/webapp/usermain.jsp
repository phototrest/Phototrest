...
$(function(){
   ...
   <div id="header">     
	...
	<div class="main_left">
		<ul>
                    <li class="rem_left1" rel="all">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;→ Whole</li>
                    <%
                        Set<Tag> tags = (Set<Tag>) request.getAttribute("tags");
                        if (tags != null) {                
                            for (Tag tag : tags) {%>
                                <li rel=<%= tag.getName() %> >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  →  <%= tag.getName()%></li> <%
                            }
                        }%>
	...
	<div class="main_right">
		<ul>
                    ...
                    <li rel="technology"><a href="#"><img src="images/port1.jpg" />#tag1 #tag2 &nbsp;&nbsp;</a><span><a class="btn btn-primary delete" href="delete?s3Key=123">Delete</a></span></li>
